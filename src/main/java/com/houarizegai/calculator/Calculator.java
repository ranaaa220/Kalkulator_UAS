...
public class Calculator {
    ...
    */
    ...
    public Calculator() {
        ...
        comboTheme = initCombo(new String[]{"Simple", "warna", "DarkTheme"}, 230, 30, "Theme", themeSwitchEventConsumer);

        comboCalcType = initCombo(new String[]{"Standard", "Scientific"}, 20, 30, "tipe kalkulator", calcTypeSwitchEventConsumer);
